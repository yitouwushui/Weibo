...
import com.yitouwushui.weibo.view.pulltorefreshview.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    public final int getContentSize() {
        switch (mScrollDirection) {
            ...
            case VERTICAL:
            default:
                return mInnerLayout.getHeight() == 0 ? 128 : mInnerLayout.getHeight();
        }
    }
    ...
    public final void refreshing(boolean showHeadView) {
        if (showHeadView) {
            refreshing();
        } else {
            refreshingImpl();
